...
// console.log(box1.__proto__);			//这个属性是一个指针指向prototype原型对象Box{name:'lee',age:100};
// console.log(box2.__proto__);			//这个属性是一个指针指向prototype原型对象
// // __proto__ ie 不支持

// console.log(box1.constructor);			//构造属性，可以获取构造函数本身function box(){}
...
// var box2 = new Box();
// console.log(box2.name);								//实例属性不会共享，所以box2访问不到实例属性，就只能访问原型
...
// console.log('name' in box1);			//不管实例属性或原型属性是否存在，只要有就返回true，两边都没有，返回false
