	...
	// console.log(navigator.appName);			//浏览器的名称，这个属性不能精确的取到浏览器的名称
	// console.log('ua:',navigator.userAgent);			//用户代理字符串，表示浏览器信息的东西
	// console.log(navigator.platform);			//操作系统,平台
	
	// console.log(BrowserDetect.browser);		//浏览器的名称
	// console.log(BrowserDetect.version);		//浏览器的版本
	// console.log(BrowserDetect.OS);			//所在的系统


	// //给IE7一下的浏览器做特殊处理
	// if (BrowserDetect.browser == 'Internet Explorer' && BrowserDetect.version < 7) {
	// 	console.log('需要做IE低版本的兼容！');
	// }
